...
[xml]$_Project=Get-Content JetBrains.Etw.HostService.Notifier.csproj
$_Framework="net461"
...
<package>
  <metadata>
    <id>JetBrains.Etw.HostService.Notifier.' + $_Runtime + '</id>
    <version>' + $_PackageVersion + '</version>
    <title>JetBrains Etw Host Service Notifier</title>
    <authors>Mikhail Pilin</authors>
    <copyright>Copyright © ' + $(get-date -Format yyyy) + ' JetBrains s.r.o.</copyright>
    <projectUrl>https://github.com/JetBrains/etw-host-service-notifier</projectUrl>
    <requireLicenseAcceptance>false</requireLicenseAcceptance>
    <license type="expression">Apache-2.0</license>
    <description>JetBrains Etw Host Service Notifier</description>
  </metadata>
  <files>
